...
public class BinderThreadTest {
  @Test
  public void classNameOutput() throws Exception {
    assertThat(BinderThread.CLASS_NAME.toString())
        .isEqualTo("android.support.annotation.BinderThread");
  }

  @Test
  public void specOutput() throws Exception {
    assertThat(BinderThread.SPEC.toString())
        .isEqualTo("@android.support.annotation.BinderThread");
  }
}