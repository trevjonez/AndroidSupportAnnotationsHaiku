 ...
 * @author TrevJonez
 */
public class StyleableResTest {
  @Test
  public void classNameOutput() throws Exception {
    assertThat(StyleableRes.CLASS_NAME.toString())
        .isEqualTo("android.support.annotation.StyleableRes");
  }

  @Test
  public void specOutput() throws Exception {
    assertThat(StyleableRes.SPEC.toString())
        .isEqualTo("@android.support.annotation.StyleableRes");
  }
}