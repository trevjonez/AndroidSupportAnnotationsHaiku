...
public class FractionResTest {
  @Test
  public void classNameOutput() throws Exception {
    assertThat(FractionRes.CLASS_NAME.toString())
        .isEqualTo("android.support.annotation.FractionRes");
  }

  @Test
  public void specOutput() throws Exception {
    assertThat(FractionRes.SPEC.toString())
        .isEqualTo("@android.support.annotation.FractionRes");
  }
}