...
public class PluralsResTest {
  @Test
  public void classNameOutput() throws Exception {
    assertThat(PluralsRes.CLASS_NAME.toString())
        .isEqualTo("android.support.annotation.PluralsRes");
  }

  @Test
  public void specOutput() throws Exception {
    assertThat(PluralsRes.SPEC.toString())
        .isEqualTo("@android.support.annotation.PluralsRes");
  }
}