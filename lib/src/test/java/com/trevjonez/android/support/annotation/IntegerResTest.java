...
public class IntegerResTest {
  @Test
  public void classNameOutput() throws Exception {
    assertThat(IntegerRes.CLASS_NAME.toString())
        .isEqualTo("android.support.annotation.IntegerRes");
  }

  @Test
  public void specOutput() throws Exception {
    assertThat(IntegerRes.SPEC.toString())
        .isEqualTo("@android.support.annotation.IntegerRes");
  }
}