...
public class AnimatorResTest {
  @Test
  public void classNameOutput() throws Exception {
    assertThat(AnimatorRes.CLASS_NAME.toString())
        .isEqualTo("android.support.annotation.AnimatorRes");
  }

  @Test
  public void specOutput() throws Exception {
    assertThat(AnimatorRes.SPEC.toString())
        .isEqualTo("@android.support.annotation.AnimatorRes");
  }
}