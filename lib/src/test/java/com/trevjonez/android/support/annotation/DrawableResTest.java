...
public class DrawableResTest {
  @Test
  public void classNameOutput() throws Exception {
    assertThat(DrawableRes.CLASS_NAME.toString())
        .isEqualTo("android.support.annotation.DrawableRes");
  }

  @Test
  public void specOutput() throws Exception {
    assertThat(DrawableRes.SPEC.toString())
        .isEqualTo("@android.support.annotation.DrawableRes");
  }
}